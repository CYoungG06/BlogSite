...
export default function AgentWidget() {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 sm:bottom-6 sm:right-6">
      {open ? (
        <div className="flex h-[min(560px,calc(100dvh-6rem))] w-[min(380px,calc(100vw-2.5rem))] flex-col overflow-hidden rounded-2xl border border-hairline bg-background shadow-2xl shadow-black/10">

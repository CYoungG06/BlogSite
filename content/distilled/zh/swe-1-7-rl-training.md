---
title: "SWE-1.7:以极低成本实现前沿智能"
date: "2026-07-08"
description: "Cognition 训练 SWE-1.7 的四大组件:top-p 采样保持熵 + 采样分布回放稳定训练、跨三大洲的多集群 RL 与容错、数据质量管线(verifier 校准 / 难度筛选 / 防作弊),以及长程任务的自我压缩与交替长度惩罚。"
tags: ["LLM", "RL", "Agent", "后训练"]
source:
  name: "Cognition Blog"
  url: "https://cognition.com/blog/swe-1-7"
  author: "Ben Pan, Carlo Baronio 等(Cognition)"
---

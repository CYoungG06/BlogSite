...
title: "规模化自动后训练"
date: "2026-08-03"
description: "Intology 的 Locus 在 PostTrainBench 登顶(44.7)，并在更大算力的 PostTrainBench+ 上达到 51.6、超越人工调优的 Qwen3-1.7B-Instruct。关键观察:低算力下排名极不稳定，约 2000 H100 小时才收敛;基线集体停滞后 Locus 仍在爬升;赢家方法从通用 SFT 转向蒸馏 + DPO + APO 的组合拳。"
tags: ["LLM", "Agent", "后训练", "AI for Research"]
source:
  name: "Intology Blog"
  url: "https://intology.ai/blog/scaling-automated-post-training"
  author: "Intology 团队"
---

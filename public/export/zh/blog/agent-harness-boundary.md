...
![近两年 Harness 研究地图。各行按照真正被修改或测量的对象组织代表工作，右侧列出常见的固定外层。](https://cyoungg06.github.io/BlogSite/images/blog/agent-harness-boundary/research-map-2026.svg)
...
![Harness Evolution 的三类数据职责。search 轨迹用于提出修改，gate 分数反复决定晋升，最终 test 在搜索结束前保持独立；底部展示需要配平的预算。](https://cyoungg06.github.io/BlogSite/images/blog/agent-harness-boundary/evaluation-evidence.svg)
